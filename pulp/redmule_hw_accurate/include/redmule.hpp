...
class RedMule : public vp::Component {
	...
	private:
    	...
    	// static void fsm_start_handler(void *__this, vp::ClockEvent *event);
    	// static void fsm_handler(void *__this, vp::ClockEvent *event);
    	// static void fsm_end_handler(void *__this, vp::ClockEvent *event);
