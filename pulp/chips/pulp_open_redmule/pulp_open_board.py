...
from pulp.chips.pulp_open_redmule.pulp_open import Pulp_open
...
class Pulp_open_board_redmule(st.Component):

    def __init__(self, parent, name, parser, options, use_ddr=False):

        super(Pulp_open_board_redmule, self).__init__(parent, name, options=options)
...
class Pulp_open_board_ddr(Pulp_open_board_redmule):
