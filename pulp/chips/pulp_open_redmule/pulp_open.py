...
from pulp.chips.pulp_open_redmule.soc import Soc
from pulp.chips.pulp_open_redmule.cluster import Cluster, get_cluster_name
...
class Pulp_open(st.Component):
    ...
    def __init__(self, parent, name, parser, soc_config_file='pulp/chips/pulp_open_redmule/soc.json',
            cluster_config_file='pulp/chips/pulp_open_redmule/cluster.json', padframe_config_file='pulp/chips/pulp_open_redmule/padframe.json',
            use_ddr=False):
