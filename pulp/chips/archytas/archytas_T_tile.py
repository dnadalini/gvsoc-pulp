...
# TODO: import Andrea Belano's RedMulE!!!
...
# Class representing the T tile of Archytas
class Archytas_T_Tile(gvsoc.systree.Component):
    def __init__(self, parent, name, parser, tid: int=0):
        ...
        # IDMA
        idma = SnitchDma(self,f'tile-{tid}-idma',loc_base=ArchytasArch.L1_ADDR_START,loc_size=ArchytasArch.L1_SIZE,tcdm_width=4)

        ### TODO: replace with Andrea Belano's RedMulE
        # # Redmule
        # redmule_nb_banks = ArchytasArch.N_MEM_BANKS
        # #redmule_bank_size = MagiaArch.N_WORDS_BANK * MagiaArch.BYTES_PER_WORD
        # redmule_bank_size = ArchytasArch.BYTES_PER_WORD
        ...
        ### TODO: bind Andrea Belano's RedMulE
        # # Bind: redmule
